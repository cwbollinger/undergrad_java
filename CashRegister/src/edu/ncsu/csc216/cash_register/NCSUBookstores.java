...
public class NCSUBookstores {
	...
	/**
	 * Constructs the NCSU Bookstore cash register and Scanner
	 */
	 ...
	 * 
	 * @param c
	 *            CurrencyCollection to refund to the user
	 */
	public void printRefund(CurrencyCollection c) {
		...
		for (int i = currency.length - 1; i >= 0; i--) {
			System.out.println(currency[i].getCount() + " "
					+ currency[i].getName());
		}
	...
	public void handlePurchase() {
		...
		try {
			// Check to see if user wants to return to main menu before asking
			// for payment
			if(itemMenuNumber == BACK_OPTION) {
				return;
			}
	...
	public CurrencyCollection processPayment() {
		...
		System.out
				.println("Enter how many of each bill or coin you will pay with:");
	 ...
	 * @return an int representing the number of bills/coins the user enters for
	 *         a payment
	 */
