...
/**
 * This class tests the functionality of ArrayList and LinkedList, including
 * adding, removing, and indexing values in these list implementations.
 * 
...
public class ListTest {
	...
	/**
	 * Initializes two ArrayLists and two LinkedLists for testing.
	 * 
	 */
	@Before
	public void setUp() {
	...
	/**
	 * Tests the functionality of adding to lists, including empty lists.
	 */
	@Test
	public void testAdd() {
	...
	/**
	 * Tests the functionality of contains.
	 */
	@Test
	...
	/**
	 * Tests the functionality of indexOf. Will return -1 if value is not in
	 * list.
	 */
	@Test
	...
	/**
	 * Tests the functionality of getting from the front, middle, and end of
	 * lists. Also checks that an IndexOutOfBoundsException is thrown when
	 * attempting to read from an invalid index.
	 */
	@Test
	public void testGet() {
	...
	/**
	 * Tests the functionality of removing from the front, middle, and end of the list.
	 */
	@Test
